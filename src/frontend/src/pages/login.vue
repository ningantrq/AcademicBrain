...
<!--              <input placeholder="输入账号" type="text" name="blur" v-model="loginForm.username" /><svg-->
...
<!--              ><input type="password" placeholder="输入密码" autocomplete="false" v-model="loginForm.password"-->
<!--            /></label>-->
